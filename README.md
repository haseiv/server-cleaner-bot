...
| Команда | Что делает |
|---|---|
| `/nuke confirm:NUKE` | Полная очистка **этого** сервера: кик всех лишних, каналы, роли, эмодзи, стикеры. Остаёшься ты, владелец и бот, плюс канал `#cleaned`. |
